...
_, _, kp_eig_vals,_ = zernike.detectAndCompute(image_0, computeEigVals=True, mask=image_0_mask, timing=False)
...
config_settings = {'set_title': dataset_name, #'K':K, 'D':D, 
                   ...
                   'NO_OF_FEATURES': NO_OF_FEATURES, 'kp_eigen_values':kp_eig_vals}
...
config_settings = {'set_title': dataset_name, #'K':K, 'D':D, 
                   ...
                   'provided_keypoints': results['keypoints'], 'kp_eigen_values':kp_eig_vals}
...
analyze_descriptor_distance_image_pair_with_eig(image_0, config_settings, plotMatches=True, saveFig=True)
