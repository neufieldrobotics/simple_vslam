...
results = analyze_descriptor_distance_image_pair_with_sift_response(image_0, config_settings, 
...
analyze_descriptor_distance_image_pair_with_sift_response(image_0, config_settings, 
                                                          mask = image_0_mask, plotMatches=True, saveFig=True)
