...
if sys.platform == 'darwin':
    ...
    path = '/home/vik748/'
fold = "data/Verdandi2_081318/"
ren_image_folder = "data/Verdandi2_081318_render/"

raw_images = sorted(glob.glob(path+fold+'*.JPG'))

outfold = "data/Verdandi2_081318_combined/"
...
for fname in progressbar.progressbar(raw_images[1555:],redirect_stdout=True):
    print ("File - ", fname)
