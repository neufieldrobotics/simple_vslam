...
zernike_obj = MultiHarrisZernike(Nfeats= 2400, seci = 5, secj = 4, levels = 6, ratio = 0.75,
...
retval, mask_e_12 = cv2.findHomography(kp0_match_01_pts, kp1_match_01_pts,
                                       ...
                                       maxIters = 1000000, confidence = 0.99999)
...
mat_img = cv2.drawMatches(gr0,kp0,gr1,kp1,good_matches,None,flags=cv2.DrawMatchesFlags_NOT_DRAW_SINGLE_POINTS)
